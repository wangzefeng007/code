var uiResource = {
    ...
    messages: {
        invalidImportFile: "文件无效,导入失败",
        duplicatedSheetName: "复制表的名字",
        duplicatedTableName: "重复的表名",
        rowColumnRangeRequired: "请选择行或列的范围",
        imageFileRequired: "文件必须是图像",
        duplicatedSlicerName: "重复的切片器的名字",
